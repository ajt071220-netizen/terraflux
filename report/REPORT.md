...
![Figure 1. The playable 3D simulator — a narrated demo game in the browser. White has just stepped onto the golden south edge (escape wins); the narration bar at the bottom explains the moment](fig_screenshot.png)
